...
function view_service () {
    ...
    # Gets the services
    Get-Service | Where-Object {$_.Status -eq $serviceToSearch} | Select-Object Status, Name, DisplayName | Sort-Object -Property Name | Export-CSV -NoTypeInformation `
    -path "C:\Users\Lucas Kaine\Desktop\lucas.kaine.logs.csv"

    # SCP file over via SSH
    Set-SCPFile -ComputerName '192.168.6.71' -Credential (Get-Credential sys320) `
    -RemotePath '/home/sys320' -LocalFile 'C:\Users\Lucas Kaine\Desktop\lucas.kaine.logs.csv'
